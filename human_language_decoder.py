...
def transcribe(file_name, composition, index):
    ...
    print("Finished Transcription! (Added:" + result["text"] + ")")
...
# pass the transcription if all threads can use the sam emodel
    ...
    def run(self):
        ...
        while True:
            ...
            t.join()    # waits for inference - should come before other thread, otherwise we won't start a new recording thread
